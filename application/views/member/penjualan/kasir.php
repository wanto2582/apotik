	...
	<body class="bgbody">
		...
		<header class="header">
		    <div class="logo-container">
		        <a href="<?php echo base_url()?>" class="logo">
		            <img src="<?php echo base_url()?>assets/images/logo1.png" height="35" alt="Logo" />
		        </a>
			...
			-->
		        ...
		        <a href="#" data-toggle="modal" data-target="#modal-hold" type="button" class="mb-xs mt-xs mr-xs btn btn-primary">
		        	<i class="fa  fa-list"></i> Pembayaran Ditahan</a>
		        </li> 
		    </ul>
                ...
                <div class="row">
                    <div class="col-md-12  col-xl-5 col-lg-5"> 
                        ...
                        <section class="panel-featured-left panel-featured-primary">  
							...
							<div class="row">
							    <div class="col-md-4"> 
							    	<button type="button" class="mb-xs mt-xs mr-xs btn btn-danger btn-lg btn-block" data-toggle="modal" data-target="#modalHapus" id="canceltransaksi"  disabled="disabled">Batal</button>
							    </div> 
							    <div class="col-md-4"> 
							    	<button type="button" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg btn-block"  data-toggle="modal" data-target="#modalHold" id="holdtransaksi"  disabled="disabled">Tahan</button>
							    </div> 
							    <div class="col-md-4"> 
							    	<button type="button" class="mb-xs mt-xs mr-xs btn btn-success btn-lg btn-block"  data-toggle="modal" data-target="#modal-payment" id="paymenttransaksi" disabled="disabled">Bayar</button>
							    </div> 
							 </div>
							</div>
                        </section>
                    ...
                    <div class="col-md-12 col-lg-7 col-xl-7"> 
                        <section class="panel-featured-right panel-featured-primary">
                            <div class="panel-body"> 
								<div class="input-group mb-md">
									<input type="text" class="form-control" id="keywords" placeholder="Cari Prodak" onkeyup="searchFilter()">
										...
										<div class="thumbnail">
											...
											<div class="row">
											    <div class="col-md-12"> 
													...
													<p><span class="btn btn-xs btn-danger">Stok : <?php echo $post['stok']; ?></span>
											    </div> 
											 </div>
 											<div class="row">
											    <div class="col-md-12">  
            ...
            <div class="modal-dialog">
                <div class="modal-content"> 
				 <?php echo form_open('penjualan/holdtransaksi',' id="FormulirHold"');?>  
					<section class="panel  panel-primary">
                    <header class="panel-heading">
                        <h2 class="panel-title">Konfirmasi Tahan Transaksi </h2>
                    </header>
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-icon">
                            ...
                            <div class="modal-text">
                                <h4>Yakin ingin Tahan transaksi ini ?</h4> 
                            </div>
        ...
        <div class="modal fade" id="modal-hold"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel panel-primary">   
                    <header class="panel-heading">
                        <h2 class="panel-title"> Pembayaran Ditahan</h2>
                    </header>
                    <div class="panel-body">
                    ...
                    <footer class="panel-footer">
						<div class="row">
							...
							<div class="table-responsive">
								<table class="table table-hover mb-none table-responsive">
									<tr>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right"> 
							<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success btn-lg btn-block" id="submitPayment" disabled>Terima Pembayaran</button>
                            </div>
                        </div>
                    </footer> 
                </section>
                ...
                $.ajax({
                    ...
                    success: function(response) { 
                         ...
                         if(response.datarows !=''){          
	                        var viewtotal='<table class="table table-striped table-responsive">';
